...
<body class="cnt-home">
								...
								<div class="product-item-holder size-big single-product-gallery small-gallery">
									...
									<div id="owl-single-product">
										...
										<div class="single-product-gallery-item" id="slide4">
											<a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage4']); ?>">
												<img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage4']); ?>" />
											</a>
										</div>

										
										<div class="single-product-gallery-item" id="slide5">
											<a data-lightbox="image-1" data-title="Gallery" href="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage5']); ?>">
												<img class="img-responsive" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage5']); ?>" />
											</a>
										</div>
										...
										<div id="owl-single-product-thumbnails">
											...
											<div class="item">
												...
												<a class="horizontal-thumb" data-target="#owl-single-product" data-slide="4" href="#slide4">
													<img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage4']); ?>" height="200" />
												</a>
											</div>

											<div class="item">
												<a class="horizontal-thumb" data-target="#owl-single-product" data-slide="5" href="#slide5">
													<img class="img-responsive" width="85" alt="" src="assets/images/blank.gif" data-echo="admin/productimages/<?php echo htmlentities($row['id']); ?>/<?php echo htmlentities($row['productImage5']); ?>" height="200" />
												</a>
											</div>
 ...
 -->
	...
	<!-- Load the switchstylesheet plugin -->
	<script src="switchstylesheet/switchstylesheet.js"></script>

	<script>
		$(document).ready(function() {
			// Ensure the plugin method exists before using it
			if ($.fn.switchstylesheet) {
				$(".changecolor").switchstylesheet({
					separator: "color" // ✅ fixed typo from 'seperator'
				});
			} else {
				console.warn("switchstylesheet plugin not loaded or not found.");
			}

			$('.show-theme-options').on('click', function() {
		...
		$(window).on("load", function() {
			...
			}, 2000); // wait 2 seconds before triggering click
		});
	</script>
