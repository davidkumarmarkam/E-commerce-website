...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$productimage5 = '';
		if (isset($_FILES["productimage5"]) && $_FILES["productimage5"]["error"] == 0) {
			$productimage5 = $_FILES["productimage5"]["name"];
			move_uploaded_file($_FILES["productimage5"]["tmp_name"], "productimages/$productid/" . $productimage5);
		}
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Product Image5</label>
											<div class="controls">
												<input type="file" name="productimage5" class="span8 tip">
											</div>
										</div>
